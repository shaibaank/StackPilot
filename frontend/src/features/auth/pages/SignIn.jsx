  ...
  return (
    <div className="hidden lg:flex lg:w-[40%] relative overflow-hidden bg-[#e7ddd3] flex-col justify-between p-10">
      ...
      <div className="relative z-10">
        <p className="text-sm text-black/60 mb-2">Welcome back</p>

        <h1 className="text-4xl font-semibold text-black leading-tight">
          Continue building full-stack applications effortlessly.
        </h1>
      </div>
    </div>
  );
...
border border-gray-200 rounded-full py-3 text-sm font-medium
...
active:translate-y-0"
        ...
        <p className="text-sm text-gray-500 mt-6">
          ...
          <Link className="text-black font-medium cursor-pointer" to="/sign-up">
            Sign up
          </Link>
        </p>
